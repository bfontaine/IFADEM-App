...
class Item
{
    ...
    * @param    array   Add some non-standard attributes on the enclosure
	* @return   void
	* @link     https://tools.ietf.org/html/rfc4288
	*/
	public function addEnclosure($url, $length, $type, $multiple = TRUE, $other_attrs=null)
	{
		...
		$attributes = array_merge($other_attrs, array('length' => $length, 'type' => $type));
